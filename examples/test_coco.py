...
model = keras.models.load_model('H:\\keras-retinanet-master\\snapshots\\resnet50_coco_best.h5', custom_objects=custom_objects)
#print(model.summary())
...
val_generator = CocoGenerator(
    'H:\\keras-retinanet-master\\datasets\\COCO',
    'val2017',
